class TaskManager
  ...
  def display_high_priority_tasks
    # could also use self.tasks to disambiguate that tasks is a setter method, not a newly initialized local variable that is being called on the same line
...
valentinas_tasks.add_task('test the program', :high)
